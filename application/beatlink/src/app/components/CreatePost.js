...
async function CreatePostApi(postTitle, spotifyLink, description, userId, playlistId) {
    try {
...
export default function CreatePost() {
    ...
    const handleSubmit = async (e) => {
        ...
        const response = await CreatePostApi(postTitle, spotifyLink, description, userId, playlistId);
